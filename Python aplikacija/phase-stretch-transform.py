...
plt.title('PST algoritam, LPF = ' + str(LPF) + ', phase_str = ' + str(Phase_strength) + ', warp_str = ' + str(Warp_strength) + ',\n t_min = ' + str(Threshold_min) + ', t_max = ' + str(Threshold_max) + ', morph_ops_flag = ' + str(Morph_flag))
